...
import com.financial.freedom.di.DatabaseModule;
import com.financial.freedom.di.NetworkModule;
...
public final class App_HiltComponents {
  ...
  @Subcomponent(
      modules = {
          AddDepositViewModel_HiltModules.KeyModule.class,
          AddHoldingViewModel_HiltModules.KeyModule.class,
          ActivityCBuilderModule.class,
          ViewModelCBuilderModule.class,
          EarningsViewModel_HiltModules.KeyModule.class,
          EditDepositViewModel_HiltModules.KeyModule.class,
          EditHoldingViewModel_HiltModules.KeyModule.class,
          HiltWrapper_ActivityRetainedComponentManager_LifecycleModule.class,
          HiltWrapper_SavedStateHandleModule.class,
          HoldingDetailViewModel_HiltModules.KeyModule.class,
          HoldingsViewModel_HiltModules.KeyModule.class,
  ...
  @Subcomponent(
      modules = {
          AddDepositViewModel_HiltModules.BindsModule.class,
          AddHoldingViewModel_HiltModules.BindsModule.class,
          EarningsViewModel_HiltModules.BindsModule.class,
          EditDepositViewModel_HiltModules.BindsModule.class,
          EditHoldingViewModel_HiltModules.BindsModule.class,
          HiltWrapper_HiltViewModelFactory_ViewModelModule.class,
          HoldingDetailViewModel_HiltModules.BindsModule.class,
          HoldingsViewModel_HiltModules.BindsModule.class,
